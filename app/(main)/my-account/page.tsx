...
export default function MyAccount() {
    ...
    return (
        <div className="p-6 md:p-10 h-full overflow-y-auto">
            ...
            {/* User Profile Card */}
            <div className="bg-white rounded-lg shadow-md p-6 md:p-8 mb-8 border border-amber-100/60">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="bg-amber-50 p-5 rounded-lg h-full border border-amber-100">
            ...
            <div className="flex flex-col md:flex-row gap-6 mb-8">
                <div className="flex-1 flex gap-4">
                    <input
                        ...
                        readOnly
                        className="flex-1 px-4 py-3 border-2 border-amber-900/10 rounded-lg bg-white text-amber-950 shadow-sm outline-none"
                    />
                    <button
                        onClick={() => handleCopyLink(1)}
                        className={`${copiedLink === 1 ? 'bg-emerald-600' : 'bg-amber-700'} text-white px-6 py-3 rounded-lg font-semibold hover:opacity-90 transition-colors whitespace-nowrap shadow-md`}
                    >
                ...
                <div className="flex-1 flex gap-4">
                    ...
                    <button
                        ...
                        className={`${copiedLink === 2 ? 'bg-emerald-600' : 'bg-amber-700'} text-white px-6 py-3 rounded-lg font-semibold hover:opacity-90 transition-colors whitespace-nowrap shadow-md`}
                    >
            ...
            <div className="mb-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                    {/* Accounting Status */}
                    <div className="bg-white rounded-lg p-6 md:p-8 shadow-sm border border-amber-100">
                        <h4 className="text-lg font-bold text-amber-950 mb-4 pb-2 border-b border-amber-100">
                            Accounting Status
                        </h4>
                        ...
                        <div className="space-y-3 text-sm">
                            <div className="flex justify-between items-center">
                                ...
                                <span className="font-semibold">
                                    <span className="text-emerald-700 bg-emerald-100 px-2 py-0.5 rounded text-xs uppercase">Active</span>
                                </span>
                            </div>
                            <div className="flex justify-between">
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border border-amber-100">
                <h3 className="text-lg font-bold text-amber-950 mb-4">Distributor Details</h3>
                <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                        <span className="text-amber-800">Sponsor ID:</span>
                        <span className="ml-2 font-mono font-semibold text-amber-950">{dashboardData.distributor.sponsorId}</span>
                    </div>
                    <div>
                        <span className="text-amber-800">Sponsor Name:</span>
                        <span className="ml-2 font-semibold text-amber-950">{dashboardData.distributor.name}</span>
                    </div>
                </div>
            </div>
            ...
            {/* Footer */}
            <footer className="bg-amber-900 text-white py-6 px-4 md:px-8 mt-8 rounded-xl">
